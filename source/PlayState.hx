...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else if (stageCheck == 'limo')
		{
			...
			skyBG = new FlxSprite(-780,-400).loadGraphic(Paths.image('limo/limoSunset'));
			...
			jet.frames = Paths.getSparrowAtlas('limo/DancerJet');
			...
			cloud = new FlxSprite(-950,75).loadGraphic(Paths.image('limo/cloud'));
			cloud.velocity.x = 20;
		...
		else if (stageCheck == 'mall')
		{
			...
			sky = new FlxSprite(-1000, -500).loadGraphic(Paths.image('christmas/sky'));
			...
			NEO.frames = Paths.getSparrowAtlas('christmas/NEO_Fireworks');
			...
			fire.frames = Paths.getSparrowAtlas('christmas/FireworkNeo');
			...
			bgEscalator = new FlxSprite(-1100, -600).loadGraphic(Paths.image('christmas/buildings'));
			...
			fgSnow = new FlxSprite(-450, -550).loadGraphic(Paths.image('christmas/mainstage'));
			fgSnow.active = false;
			...
			Boppers2.frames = Paths.getSparrowAtlas('christmas/CrowdRight');
		...
		else if (stageCheck == 'mallEvil')
		{
			...
			skyCorrupt = new FlxSprite(-1000, -500).loadGraphic(Paths.image('christmas/skycorrupted'));
			...
			bgEscalator = new FlxSprite(-1100, -600).loadGraphic(Paths.image('christmas/Scary-buildings'));
			bgEscalator.antialiasing = true;
			...
			fgSnow = new FlxSprite(-450, -550).loadGraphic(Paths.image('christmas/mainstagecorruption'));
			fgSnow.active = false;
			fgSnow.antialiasing = true;
			fgSnow.setGraphicSize(Std.int(fgSnow.width * 1.25));
			add(fgSnow);
			...
			corruptedBoppers.frames = Paths.getSparrowAtlas('christmas/Corrupted_bg_characters');
			...
			var fgTables:FlxSprite = new FlxSprite(-450, -550).loadGraphic(Paths.image('christmas/maintablescorruption'));
